...
class __$$LoadedImplCopyWithImpl<$Res>
    extends _$GoogleSignInStateCopyWithImpl<$Res, _$LoadedImpl>
...
class _$LoadedImpl implements _Loaded {
  const _$LoadedImpl({required this.token});
  ...
  @override
  String toString() {
    return 'GoogleSignInState.loaded(token: $token)';
  }
...
abstract class _Loaded implements GoogleSignInState {
  const factory _Loaded({required final String token}) = _$LoadedImpl;
